  ...
  n = function () {
    ...
    e = function (e) {
      ...
      if (a["content-length"]) {
        ...
        r = null;
        for (c = b = p, y = e.length; p <= y ? b < y : b > y;
            c = p <= y ? ++b : --b) {
          r = e.charAt(c);
          if (r === t.NULL) {
            break
  ...
  e = function () {
    ...
    r.prototype.debug = function (t) {
      ...
      return typeof window !== "undefined" && window !== null
          ? (e = window.console) != null ? e.log(t) : void 0 : void 0
    };
    e = function () {
      if (Date.now) {
        return Date.now()
    ...
    r.prototype.connect = function () {
      ...
      this.ws.onmessage = function (i) {
        return function (r) {
          ...
          c = typeof ArrayBuffer !== "undefined" && r.data
          instanceof ArrayBuffer ? (o = new Uint8Array(r.data), typeof i.debug
          === "function" ? i.debug("--- got data length: " + o.length)
              : void 0, function () {
            var t, e, n;
            n = [];
          ...
          for (d = 0, g = b.length; d < g; d++) {
            ...
            switch (f.command) {
              case"CONNECTED":
                ...
                m.push(
                    typeof i.connectCallback === "function" ? i.connectCallback(
                        f) : void 0);
                break;
              case"MESSAGE":
                ...
                if (l) {
                  ...
                  m.push(typeof i.debug === "function" ? i.debug(
                      "Unhandled received MESSAGE: " + f) : void 0)
                }
                break;
              case"RECEIPT":
                m.push(typeof i.onreceipt === "function" ? i.onreceipt(f)
                    : void 0);
                break;
              case"ERROR":
