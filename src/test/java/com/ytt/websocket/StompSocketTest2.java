 ...
 * @date 2018/6/27
 */
public class StompSocketTest2 {
    private static Logger logger = LoggerFactory.getLogger(StompSocketTest2.class);
    ...
    public void testStompSubscribe() throws ExecutionException, InterruptedException {
        ...
        ListenableFuture<StompSession> f = helloClient.connect("ws://localhost:8080/register?id=2");
        ...
        //stompSession.send("/app/oncall","11111");
        //stompSession.send("/app/play","11111");
        Thread.sleep(600000);
    }
    ...
    public void subscribeGreetings(String url, StompSession stompSession) throws ExecutionException, InterruptedException {
        ...
        stompHeaders.set("content-type","application/json");
        stompHeaders.setDestination("/app/oncall");
        stompSession.send(stompHeaders,new byte[1231231]);
    }
